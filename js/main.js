...
//
function swalAlertEnviar() {
    Swal.fire({
        title: 'Cosypro LTDA',
        text: 'Enviamos tu pedido, nuestros encargados de ventas se pondran en contacto!!!',
        imageUrl: '../img/CosyproLogo.webp',
        imageWidth: 400,
        imageHeight: 200,
        imageAlt: 'Logo Cosypro',
...
function swalAlertError(){
    Swal.fire({
        icon: 'error',
        title: 'Error',
        text: 'Para enviar el presupuesto, primero debes agregar productos',
